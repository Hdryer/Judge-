...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if(StringUtils.isNotBlank((answer) )&& answer.length()>8198){
        ...
        if(StringUtils.isNotBlank((judgeCase) )&& judgeCase.length()>8198){
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "题目实例过长");
        }
        if(StringUtils.isNotBlank((judgeConfig) )&& judgeConfig.length()>8198){
